...
var UserService = function () {
    ...
    var UserService = _classThis = /** @class */ (function () {
        function UserService_1(httpClient) {
            this.httpClient = httpClient;
        }
        UserService_1.prototype.addUser = function (addCategoryrequest) {
            return this.httpClient.post("https://localhost:7244/UserInfo", addCategoryrequest);
        };
